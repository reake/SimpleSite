    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li>
                    <div class="m-t-sm"><a
                            href="<?php p($loginUrl); ?>" class="btn btn-sm btn-success m-l"><strong>注册/登陆</strong></a></div>
                </li>
            </ul>
        </div>
    </div>
...
<section id="content">
        ...
        <div class="text-center wrapper">
            <div class="m-t-xl m-b-xl">
                <div class="text-uc h1 font-bold inline">
                    <div class="pull-left m-r-sm text-white">建站（简站 Simple-Site）从未 <span
                            class="font-thin text-muted">如此</span></div>
            ...
            <p class="text-center m-b-xl"><a href="http://themeforest.net/user/Flatfull/portfolio?ref=flatfull"
                                             target="_blank" class="btn btn-lg btn-dark m-sm">下载源码</a> <a
                    href="index.html" target="_blank" class="btn btn-lg btn-warning b-white bg-empty m-sm">在线试用</a></p>
        </div>
        <div class="padder">
            <div class="hbox">
    ...
    <div id="about">
        <div class="container">
            <div class="m-t-xl m-b-xl text-center wrapper"><h3>Responsive web application and admin dashboard
                template</h3>
            ...
            <div class="row m-t-xl m-b-xl text-center">
                <div class="col-sm-4" data-ride="animated" data-animation="fadeInLeft" data-delay="300"><p
                        class="h3 m-b-lg"><i class="fa fa-lightbulb-o fa-3x text-info"></i></p>

                    <div class=""><h4 class="m-t-none">开放全部源码</h4>

                        <p class="text-muted m-t-lg">Many mobile app widgets and components, it's fully responsive, it
                            can run on all the size of the screens. Start work on your great idea today!</p></div>
                </div>
                <div class="col-sm-4" data-ride="animated" data-animation="fadeInLeft" data-delay="600"><p
                        class="h3 m-b-lg"><i class="fa fa-signal fa-3x text-info"></i></p>

                    <div class=""><h4 class="m-t-none">模块化开发</h4>

                        <p class="text-muted m-t-lg">It also can be used as admin dashboard, it has tables, charts and
                            other useful components for system management, graph data shows and analysis.</p></div>
                </div>
            ...
            <div class="m-t-xl m-b-xl text-center wrapper"><p class="h5">您可以使用此系统搭建 <span
                    class="text-primary">官网网站</span>, <span class="text-primary">微信公众平台</span>,
                <span class="text-primary">微网站</span>... </p></div>
        </div>
    </div>
    <div id="responsive" class="bg-dark">
        <div class="text-center">
            <div class="container">
                <div class="m-t-xl m-b-xl wrapper"><h3 class="text-white">一套系统管理所有网站</h3>
...
<footer id="footer">
    <div class="bg-primary text-center">
        <div class="container wrapper">
            <div class="m-t-xl m-b"> 重新定义建站 - 让您专注您更专业的事情 <a
                    href="http://themeforest.net/user/Flatfull/portfolio?ref=flatfull" target="_blank"
                    class="btn btn-lg btn-dark b-white bg-empty m-sm">下载源码</a> <a href="index.html"
                                                                                  target="_blank"
                                                                                  class="btn btn-lg btn-warning b-white bg-empty m-sm">在线试用</a>
            </div>
        </div>
        ...
        <div class="container text-center m-t-lg">
            <div class="row m-t-xl m-b-xl">
                <div class="col-sm-4" data-ride="animated" data-animation="fadeInLeft" data-delay="300"><i
                        class="fa fa-map-marker fa-3x icon-muted"></i> <h5 class="text-uc m-b m-t-lg">商业合作</h5>

                    <p class="text-sm"><a href="mailto:hey@example.com">service@simple-site.cn</a></p></div>
                <div class="col-sm-4" data-ride="animated" data-animation="fadeInUp" data-delay="600"><i
                        class="fa fa-envelope-o fa-3x icon-muted"></i> <h5 class="text-uc m-b m-t-lg">联系我们</h5>

                    <p class="text-sm"><a href="mailto:hey@example.com">admin@simple-site.cn</a></p></div>
                <div class="col-sm-4" data-ride="animated" data-animation="fadeInRight" data-delay="900"><i
                        class="fa fa-globe fa-3x icon-muted"></i> <h5 class="text-uc m-b m-t-lg">加入我们</h5>

                    <p class="text-sm"><a href="mailto:hey@example.com">developer@simple-site.cn</a>
                    </p></div>
            </div>
            <div class="m-t-xl m-b-xl">
                <p>
                    <a href="#" class="btn btn-icon btn-rounded btn-facebook bg-empty m-sm"><i
                            class="fa fa-github"></i></a>
                    <a href="#" class="btn btn-icon btn-rounded btn-twitter bg-empty m-sm"><i
                            class="fa fa-weibo"></i></a>
                    <a href="#" class="btn btn-icon btn-rounded btn-gplus bg-empty m-sm"><i
                            class="fa fa-qrcode"></i></a>
                </p>

                <p>
                    <a href="#content" data-jump="true"
