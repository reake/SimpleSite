	...
	<section class="panel panel-default">
		<div class="row m-l-none m-r-none bg-light lter">
			<div class="col-sm-6 col-md-3 padder-v b-r b-light">
				...
				<a class="clear" href="<?php p($siteUrl); ?>/_assets/#">
					<span class="h3 block m-t-xs"><strong>52,000</strong></span>
					<small class="text-muted text-uc">总用户数</small>
				</a>
			</div>
			...
			<div class="col-sm-6 col-md-3 padder-v b-r b-light"><span
					class="fa-stack fa-2x pull-left m-r-sm"> <i
						...
						data-update="5000"></span> </span> <a class="clear" href="<?php p($siteUrl); ?>/_assets/#"> <span
						class="h3 block m-t-xs"><strong id="firers">359</strong></span>
					<small class="text-muted text-uc">今日报名</small>
				</a>
			</div>
			<div class="col-sm-6 col-md-3 padder-v b-r b-light lt">
				<span class="fa-stack fa-2x pull-left m-r-sm">
				...
				<a class="clear" href="<?php p($siteUrl); ?>/_assets/#">
					<span class="h3 block m-t-xs"><strong>31123</strong></span>
					<small class="text-muted text-uc">微信消息数</small>
				</a>
			</div>
		</div>
	</section>
